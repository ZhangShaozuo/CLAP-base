...
'''command
python3 tSNE.py --restore_step 20000 --device 3 --type a
python3 tSNE.py --restore_step 20000 --device 1 --type l
'''
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--restore_step', type=str, required=False)
    parser.add_argument('--device', type=int, default=2, required=False)
